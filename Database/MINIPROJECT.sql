...
-- Tiempo de generación: 13-09-2024 a las 01:36:40
...
(1, 'Laptop HP', 750, 9, 'Laptop HP con procesador Intel Core i5, 8GB RAM, 256GB SSD.'),
...
(6, 'a', 1, 0, 'abc'),
(7, 'Tarjeta de Steam ($50)', 50, 486, 'Tarjeta con codigo para redimir $50 (en dolares) en la plataforma de videojuegos Steam');
...
(1, 'Alejandro', NULL, 'Sarmiento', 'Rivera', 'alesansarive', 'admin', 'alesansarive@javerianacali.edu.co', 1116328190, 1),
(2, 'Juan', 'Esteban', 'Becerra', 'Gutierrez', 'junes', 'ci', 'juanesbecerra04@javerianacali.edu.co', 1112038890, 2);
...
--
ALTER TABLE `venta`
  MODIFY `NroVenta` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
